    ...
    return(
        <Container className="numberPadContainer">
            ...
            <Row><Col><table className="tableCenter">
                ...
                <tr>
                    <td><Button className="numpadButton" variant="outlined" color="primary" onClick={ () =>{newAction("clear")}}>Clear</Button></td>
                    <td><Button className="numpadButton" variant="outlined" color="primary" onClick={ () =>{newAction(0)}}>0</Button></td>
                    <td><Button className="numpadButton" variant="outlined" color="primary" onClick={ () =>{newAction("delete")}}>Delete</Button></td>
                </tr>
            </table></Col></Row>
        </Container>
    )
